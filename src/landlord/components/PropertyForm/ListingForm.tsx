...
import { X, Plus, FileText, DollarSign, Calendar, Camera, User } from 'lucide-react';
...
const ListingForm: React.FC<ListingFormProps> = ({ 
  ...
  const listingImageUploadId = `listingImageUpload-${listingId}`;
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-gray-600">Select all lease terms you're willing to offer for this listing</p>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
              {LEASE_TERM_OPTIONS.map((term) => (
                <div key={term} className="flex items-center space-x-2">
                  ...
                  />
                  <Label 
                    htmlFor={`listing-lease-term-${term}`}
        ...
        <div className="space-y-6">
          ...
          >
            <input
              ...
              className="hidden"
            />
            <label htmlFor={listingImageUploadId} className={`cursor-pointer ${isUploading ? 'cursor-not-allowed' : ''}`}>
              <div className="flex flex-col items-center">
                {isUploading ? (
                  ...
                  <>
                    ...
                    <Button type="button" variant="outline" disabled={isUploading} className="px-6 py-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                      Choose Images
                    </Button>
                  </>
                )}
